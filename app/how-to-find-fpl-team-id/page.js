      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 className={`${lexend.className} mb-4 text-4xl tracking-tight font-bold text-[#06000c] dark:text-white`}>
            ...
            <div className="mb-4 text-[#06000c]">
              <ul className="list-decimal">
                <li>
                  Login to your FPL account and navigate to the points
                  page
                </li>
                <li>
                ...
                <li>In the below example, the FPL Team ID is 7870392</li>
              </ul>
              <p>
